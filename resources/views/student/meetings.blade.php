...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Meeting History</h1>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="{{ route('student.meetings.view', $meeting->id) }}" class="text-blue-600 hover:text-blue-900">View</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div class="mt-6">
        <button onclick="window.location.href='{{ route('student.meetings.create') }}'" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">
