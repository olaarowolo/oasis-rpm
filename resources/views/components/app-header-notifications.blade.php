...
>
    ...
    >
        ...
        <div class="mt-2 border-t border-slate-200 pt-2 dark:border-slate-700">
            <a href="{{ $viewAllHref }}" class="block rounded-xl px-3 py-2 text-center text-sm font-medium text-academic-700 transition hover:bg-academic-50 dark:text-academic-300 dark:hover:bg-academic-900/30">
                View all context
            </a>
        </div>
    </div>
