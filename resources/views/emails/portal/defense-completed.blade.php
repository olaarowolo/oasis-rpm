...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid {{ $line }};border-radius:16px;overflow:hidden;">
  ...
  <div style="padding:24px;">
    ...
    <p style="margin:0 0 14px;"><span style="display:inline-block;padding:4px 10px;border-radius:999px;background:#059669;color:#fff;font-size:11px;font-weight:700;letter-spacing:.3px;">COMPLETE</span></p>
    <p style="margin:0 0 14px;color:{{ $ink }};font-size:14px;line-height:1.6;">Congratulations! All sections of your defense manuscript have been accepted. Your manuscript defense readiness is now complete and the <strong>Submit for Defense</strong> button is enabled.</p>
