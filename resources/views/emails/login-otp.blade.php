                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; overflow:hidden; border:1px solid #e5e7eb;">
                    ...
                    <tr>
                        <td style="padding:32px 28px;">
                            <p style="margin:0 0 12px; font-size:20px; font-weight:bold; color:#111827;">Hello {{ $name }},</p>
                            <p style="margin:0 0 20px; font-size:16px; line-height:1.6; color:#374151;">
                                Use the verification code below to sign in to your {{ $role }} account.
                            </p>
                            <div style="text-align:center; padding:22px 14px; background:#f8fafc; border:1px solid #e2e8f0; border-radius:10px; margin:20px 0;">
                                ...
                                <div style="font-size:36px; font-weight:bold; letter-spacing:8px; color:#0f172a;">{{ $otpCode }}</div>
                            </div>
