...
>
        ...
        <div>
          ...
          <div class="reveal delay-1 mt-4 inline-flex items-center gap-2 rounded-xl border border-academic-100 bg-white/85 backdrop-blur px-3 py-2 shadow-sm">
            ...
            <span class="inline-flex items-center rounded-md bg-academic-900 px-2 py-1">
              <img src="{{ asset('img/afriscribe-logo-white.png') }}" alt="Afriscribe" class="h-5 sm:h-6 w-auto" loading="lazy" decoding="async">
            </span>
          </div>
          ...
          <div class="reveal delay-3 mt-7 flex flex-col sm:flex-row gap-3">
            <a href="{{ route('login') }}" class="btn-animate inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-academic-800 hover:bg-academic-900 text-white font-semibold shadow-glow transition">
  ...
  <section id="roles" class="section-reveal py-16 sm:py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-8 grid md:grid-cols-3 gap-4">
        <a href="{{ route('public.solutions.students') }}" class="elevate rounded-2xl border border-slate-200 bg-white p-5 no-underline">
        ...
        <a href="{{ route('public.solutions.supervisors') }}" class="elevate rounded-2xl border border-slate-200 bg-white p-5 no-underline">
        ...
        <a href="{{ route('public.solutions.administrators') }}" class="elevate rounded-2xl border border-slate-200 bg-white p-5 no-underline">
  ...
  <section class="section-reveal py-14 bg-academic-900 text-white">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <a href="{{ route('login') }}" class="btn-animate mt-6 inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-amber-400 text-slate-950 font-semibold hover:bg-amber-300 transition">
