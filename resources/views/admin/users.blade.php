...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="window.location.href='{{ route('admin.users.create') }}'" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">
            Add New User
        </button>
    </div>
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        @if($user->role === 'student' && $user->student)
                            {{ ucfirst($user->student->status ?? 'unknown') }}
                        @else
                            Active
                        @endif
                    </td>
