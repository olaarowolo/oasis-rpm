...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <button onclick="window.location.href='{{ route('admin.resources.create') }}'" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">
            Add Resource
        </button>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        ...
                        <form class="inline-block" action="{{ route('admin.resources.destroy', $resource->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
