...
<aside id="app-sidebar" aria-label="Supervisor navigation" class="w-full md:w-64 flex-shrink-0 bg-slate-50 dark:bg-slate-900 md:bg-transparent md:dark:bg-transparent">
    ...
    <nav class="bg-white dark:bg-slate-800 rounded-2xl p-2 shadow-sm border border-slate-200 dark:border-slate-700 space-y-1">
        ...
        <a href="<?php echo e(route('supervisor.dashboard')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('supervisor.dashboard') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-chart-line w-5 text-center text-academic-600 dark:text-academic-400"></i>
            Dashboard
        </a>
        <a href="<?php echo e(route('supervisor.students')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('supervisor.students') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-users w-5 text-center"></i>
            Student Roster
        </a>
        <a href="<?php echo e(route('supervisor.proposals')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('supervisor.proposals') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-file-signature w-5 text-center"></i>
            Topic Approvals
        </a>
        <a href="<?php echo e(route('supervisor.meetings')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('supervisor.meetings', 'supervisor.meetings.*') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-comments w-5 text-center"></i>
            Meeting Logs
        </a>
        <a href="<?php echo e(route('supervisor.analytics')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('supervisor.analytics') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-chart-pie w-5 text-center text-purple-500"></i>
            Analytics
        </a>
        <a href="<?php echo e(route('supervisor.resources.pending')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('supervisor.resources.pending') ? $activeClasses : $idleClasses); ?>">
    ...
    <div class="mt-4 p-4 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
        ...
        <?php if(!empty($sidebarSupervisorProfile['bookingUrl'])): ?>
            <a href="<?php echo e($sidebarSupervisorProfile['bookingUrl']); ?>" target="_blank" rel="noopener" class="flex items-center justify-between gap-2 p-3 rounded-xl bg-academic-600 hover:bg-academic-700 text-white font-bold shadow-md transition">
...
</aside><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/supervisor/partials/sidebar.blade.php ENDPATH**/ ?>