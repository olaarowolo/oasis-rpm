...
<aside id="app-sidebar" aria-label="Primary navigation" class="w-full md:w-64 flex-shrink-0 bg-slate-50 dark:bg-slate-900 md:bg-transparent md:dark:bg-transparent">
  ...
  <nav class="bg-white dark:bg-slate-800 rounded-2xl p-2 shadow-sm border border-slate-200 dark:border-slate-700 space-y-1">
    ...
    <div class="space-y-1">
      ...
      <a href="<?php echo e(route('student.dashboard', ['tab' => 'student-dashboard'])); ?>" id="nav-student-dashboard" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold rounded-xl transition bg-academic-50 text-academic-700 dark:bg-academic-900/40 dark:text-academic-100">
        <i class="fa-solid fa-book-open-reader w-5 text-center text-academic-600 dark:text-academic-400"></i>
        My Research Portal
      </a>

      <a href="<?php echo e(route('student.dashboard', ['tab' => 'student-roadmap'])); ?>" id="nav-student-roadmap" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
        <i class="fa-solid fa-list-check w-5 text-center"></i>
        Research Roadmap
      </a>

      <a href="<?php echo e(route('student.dashboard', ['tab' => 'student-proposals'])); ?>" id="nav-student-proposals" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
      ...
      <a href="<?php echo e(url('/student/meetings')); ?>" id="nav-student-meetings" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
        <i class="fa-solid fa-comments w-5 text-center"></i>
        Meeting Logs
      </a>

      <a href="<?php echo e(url('/student/resources')); ?>" id="nav-student-resources" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
        <i class="fa-solid fa-graduation-cap w-5 text-center text-academic-600 dark:text-academic-400"></i>
        Learning Resources
      </a>

      <a href="<?php echo e(url('/student/defense-readiness')); ?>" id="nav-defense-readiness" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
  ...
  <div class="mt-4 p-4 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm text-xs space-y-3">
    <div class="flex items-center gap-3">
      <div id="sidebar-supervisor-avatar" class="w-10 h-10 rounded-xl bg-academic-800 text-amber-400 font-extrabold flex items-center justify-center text-sm shadow-md">
        <?php echo e($studentSidebarSupervisorInitials); ?>

      </div>
      <div class="min-w-0">
        <h4 id="sidebar-supervisor-name" class="font-bold text-slate-900 dark:text-white text-xs truncate"><?php echo e($studentSidebarSupervisorName); ?></h4>
        <p id="sidebar-supervisor-title" class="text-[10px] text-slate-500 dark:text-slate-400"><?php echo e($studentSidebarSupervisorTitle); ?></p>
      </div>
    </div>
    ...
    <div class="pt-2 border-t border-slate-100 dark:border-slate-700 space-y-1.5 text-[11px]">
      <div class="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
        ...
        <span id="sidebar-supervisor-dept" class="truncate"><?php echo e($studentSidebarSupervisorDepartment); ?></span>
      </div>
      <div class="flex items-center gap-1.5 font-mono text-[10px] text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-900 p-1.5 rounded-lg border border-slate-100 dark:border-slate-800">
        ...
        <span id="sidebar-supervisor-email" class="truncate"><?php echo e($studentSidebarSupervisorEmail); ?></span>
      </div>
    </div>
  </div>
  ...
  <div class="mt-4 p-4 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm">
    ...
    <?php if($studentSidebarBookingUrl): ?>
      <a href="<?php echo e($studentSidebarBookingUrl); ?>" target="_blank" rel="noopener"
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/partials/dashboards/student-sidebar.blade.php ENDPATH**/ ?>