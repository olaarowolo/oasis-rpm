...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9f9f9; padding: 30px; border: 1px solid #ddd; border-top: none; border-radius: 0 0 10px 10px;">
        <h2 style="color: #102a43; margin-top: 0;">
            <?php echo e($status === 'approved' ? '🎉 Resource Approved' : '⚠️ Resource Rejected'); ?>

        </h2>

        <p>Hello,</p>

        <p>Your resource submission has been <?php echo e($status === 'approved' ? 'approved' : 'rejected'); ?> by your supervisor.</p>

        <div style="background: #fff; padding: 20px; border-radius: 8px; border: 1px solid #ddd; margin: 20px 0;">
            <h3 style="color: #102a43; margin-top: 0;"><?php echo e($resourceTitle); ?></h3>
            
            <?php if($status === 'approved'): ?>
                <p style="color: #28a745; font-weight: bold;">
                    ✅ Your resource has been APPROVED!
                </p>
                <p><strong>Points Earned:</strong> <?php echo e($pointsEarned); ?></p>
            <?php else: ?>
            ...
            <?php if($comment): ?>
                <div style="margin-top: 20px; padding: 15px; background: #f8f9fa; border-left: 4px solid #102a43;">
                    ...
                    <p style="margin: 5px 0 0; color: #666;"><?php echo e($comment); ?></p>
                </div>
            <?php endif; ?>
        </div>
    ...
    <div style="text-align: center; padding: 20px; color: #666; font-size: 12px;">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> TheOAsis Research Supervision Portal. All rights reserved.</p>
    </div>
</body>
</html><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/emails/resource-approval.blade.php ENDPATH**/ ?>