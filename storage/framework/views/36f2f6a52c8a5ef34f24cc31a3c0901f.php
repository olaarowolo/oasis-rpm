...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid <?php echo e($line); ?>;border-radius:16px;overflow:hidden;">
  ...
  <div style="padding:24px;">
    ...
    <p style="margin:0 0 14px;color:<?php echo e($ink); ?>;font-size:14px;line-height:1.6;">Good morning, Dr. Arowolo. Here is your pending-items summary:</p>
    <table style="width:100%;border-collapse:collapse;margin:0 0 14px;">
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Proposals pending approval</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($pendingProposals ?? 0); ?></td></tr>
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Meeting logs pending / under review</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($pendingLogs ?? 0); ?></td></tr>
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Resources awaiting review</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($pendingResources ?? 0); ?></td></tr>
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Total supervised students</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($totalStudents ?? 0); ?></td></tr>
    </table>
    <?php if(!empty($url)): ?>
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/emails/portal/digest.blade.php ENDPATH**/ ?>