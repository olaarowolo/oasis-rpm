...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid <?php echo e($line); ?>;border-radius:16px;overflow:hidden;">
  ...
  <div style="padding:24px;">
    ...
    <p style="margin:0 0 14px;color:<?php echo e($ink); ?>;font-size:14px;line-height:1.6;"><?php echo e($studentName); ?> submitted a topic proposal for your review.</p>
    ...
    <table style="width:100%;border-collapse:collapse;margin:0 0 14px;">
      ...
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Proposal</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($proposalId ?? ''); ?></td></tr>
    </table>
    <?php if(!empty($abstract)): ?>
      <p style="margin:0 0 14px;color:<?php echo e($ink); ?>;font-size:14px;line-height:1.6;">Abstract: <?php echo e($abstract); ?></p>
    <?php endif; ?>
    <?php if(!empty($url)): ?>
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/emails/portal/topic-submitted.blade.php ENDPATH**/ ?>