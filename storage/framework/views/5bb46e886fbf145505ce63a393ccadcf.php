...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Admin Dashboard | TheOAsis Research Supervision System']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Admin Dashboard | TheOAsis Research Supervision System']); ?>
  <?php
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="hidden md:flex items-center gap-3 pl-3 border-l border-slate-200 dark:border-slate-700">
          ...
          <div class="text-left leading-tight">
            <p class="text-xs font-semibold text-slate-800 dark:text-slate-100"><?php echo e($adminName); ?></p>
            <p class="text-[10px] text-slate-500 dark:text-slate-400"><?php echo e($roleLabel); ?></p>
          </div>
        </div>
  ...
  <aside id="app-sidebar" aria-label="Admin navigation" class="md:hidden w-full flex-shrink-0 bg-slate-50 dark:bg-slate-900">
    ...
    <nav class="bg-white dark:bg-slate-800 rounded-2xl p-2 shadow-sm border border-slate-200 dark:border-slate-700 space-y-1" aria-label="Admin navigation">
      ...
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold rounded-xl transition bg-academic-50 text-academic-700 dark:bg-academic-900/40 dark:text-academic-100">
        <i class="fa-solid fa-chart-line w-5 text-center text-academic-600 dark:text-academic-400"></i>
        Dashboard
      </a>
      <a href="<?php echo e(route('admin.users')); ?>" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
        <i class="fa-solid fa-users w-5 text-center"></i>
        Users
      </a>
      <a href="<?php echo e(route('admin.config')); ?>" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
        <i class="fa-solid fa-sliders w-5 text-center"></i>
        Configuration
      </a>
      <a href="<?php echo e(route('admin.resources')); ?>" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
        <i class="fa-solid fa-book-open w-5 text-center"></i>
        Resources
      </a>
      <a href="<?php echo e(route('admin.audit-logs')); ?>" class="nav-btn w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-medium rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
    ...
    <section class="grid grid-cols-1 xl:grid-cols-[1.25fr_0.75fr] gap-6">
      <div class="space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <a href="<?php echo e(route('admin.users', ['role' => 'supervisor'])); ?>" class="rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-5 shadow-sm hover:shadow-md transition group">
            <div class="flex items-start justify-between gap-3">
              <div>
...
<?php endif; ?><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/admin-dashboard.blade.php ENDPATH**/ ?>