...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid <?php echo e($line); ?>;border-radius:16px;overflow:hidden;">
  ...
  <div style="padding:24px;">
    ...
    <p style="margin:0 0 14px;color:<?php echo e($ink); ?>;font-size:14px;line-height:1.6;"><?php echo e($studentName ?? 'A student'); ?> has marked a learning resource as complete and is awaiting your review.</p>
    ...
    <table style="width:100%;border-collapse:collapse;margin:0 0 14px;">
      ...
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Matric</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($matric ?? ''); ?></td></tr>
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Points</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($points ?? 0); ?></td></tr>
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Submitted</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($submittedDate ?? ''); ?></td></tr>
    </table>
    <?php if(!empty($url)): ?>
      <p style="margin:6px 0 14px;"><a href="<?php echo e($url); ?>" style="display:inline-block;padding:10px 18px;background:<?php echo e($brandDark); ?>;color:#fff;text-decoration:none;border-radius:10px;font-size:13px;font-weight:700;">Review in the portal</a></p>
    <?php endif; ?>
  </div>
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/emails/portal/resource-submitted.blade.php ENDPATH**/ ?>