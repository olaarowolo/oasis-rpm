    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl p-6 border border-slate-200 dark:border-slate-700 shadow-sm space-y-4">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 dark:border-slate-700 pb-4 gap-3">
        ...
        <div class="flex items-center gap-2 flex-wrap">
          ...
          <button onclick="window.location.href='<?php echo e(url('/student/meetings')); ?>'" class="px-3.5 py-2 bg-academic-700 hover:bg-academic-800 text-white rounded-xl text-xs font-semibold shadow-md transition flex items-center gap-1.5">
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/partials/dashboards/student-content.blade.php ENDPATH**/ ?>