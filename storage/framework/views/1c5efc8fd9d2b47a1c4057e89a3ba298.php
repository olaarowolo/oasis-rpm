...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid <?php echo e($line); ?>;border-radius:16px;overflow:hidden;">
  ...
  <div style="padding:24px;">
    ...
    <p style="margin:0 0 14px;color:<?php echo e($ink); ?>;font-size:14px;line-height:1.6;">Your supervisor has requested a revision of your proposed topic. Please revise and resubmit.</p>
    ...
    <?php endif; ?>
    <?php if(!empty($url)): ?>
      <p style="margin:6px 0 14px;"><a href="<?php echo e($url); ?>" style="display:inline-block;padding:10px 18px;background:<?php echo e($brandDark); ?>;color:#fff;text-decoration:none;border-radius:10px;font-size:13px;font-weight:700;">Revise in the portal</a></p>
    <?php endif; ?>
  </div>
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/emails/portal/topic-revision.blade.php ENDPATH**/ ?>