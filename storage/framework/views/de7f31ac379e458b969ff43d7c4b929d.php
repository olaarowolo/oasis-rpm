...
<div style="max-width:560px;margin:0 auto;background:#fff;border:1px solid <?php echo e($line); ?>;border-radius:16px;overflow:hidden;">
  ...
  <div style="padding:24px;">
    ...
    <p style="margin:0 0 14px;color:<?php echo e($ink); ?>;font-size:14px;line-height:1.6;">Your supervisor has approved this learning resource. You have earned <?php echo e($points ?? 0); ?> point(s).</p>
    <blockquote style="margin:0 0 14px;padding:12px 16px;background:<?php echo e($bg); ?>;border-left:4px solid <?php echo e($brandGold); ?>;border-radius:8px;color:<?php echo e($ink); ?>;font-size:14px;">“<?php echo e($resourceTitle ?? ''); ?>”</blockquote>
    <?php if(!empty($feedback)): ?>
      <blockquote style="margin:0 0 14px;padding:12px 16px;background:<?php echo e($bg); ?>;border-left:4px solid <?php echo e($brandGold); ?>;border-radius:8px;color:<?php echo e($ink); ?>;font-size:14px;">Supervisor comment: <?php echo e($feedback); ?></blockquote>
    <?php endif; ?>
    <table style="width:100%;border-collapse:collapse;margin:0 0 14px;">
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Points awarded</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($points ?? 0); ?></td></tr>
      <tr><td style="padding:6px 12px 6px 0;color:<?php echo e($muted); ?>;font-size:12px;white-space:nowrap;vertical-align:top;">Approved on</td><td style="padding:6px 0;color:<?php echo e($ink); ?>;font-size:13px;"><?php echo e($reviewedDate ?? ''); ?></td></tr>
    </table>
    <?php if(!empty($url)): ?>
...
<?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/emails/portal/resource-approved.blade.php ENDPATH**/ ?>