...
<aside id="app-sidebar" aria-label="Admin navigation" class="w-full md:w-72 flex-shrink-0 bg-slate-50 dark:bg-slate-900 md:bg-transparent md:dark:bg-transparent">
    ...
    <nav class="bg-white dark:bg-slate-800 rounded-2xl p-2 shadow-sm border border-slate-200 dark:border-slate-700 space-y-1">
        ...
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('admin.dashboard') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-chart-line w-5 text-center text-academic-600 dark:text-academic-400"></i>
            Dashboard
        </a>
        <a href="<?php echo e(route('admin.users')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('admin.users') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-users w-5 text-center"></i>
            Users
        </a>
        <a href="<?php echo e(route('admin.config')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('admin.config') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-sliders w-5 text-center"></i>
            Configuration
        </a>
        <a href="<?php echo e(route('admin.resources')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('admin.resources', 'admin.resources.*') ? $activeClasses : $idleClasses); ?>">
            <i class="fa-solid fa-book-open w-5 text-center"></i>
            Resources
        </a>
        <a href="<?php echo e(route('admin.audit-logs')); ?>" class="<?php echo e($navLinkClasses); ?> <?php echo e(request()->routeIs('admin.audit-logs', 'admin.audit-logs.*') ? $activeClasses : $idleClasses); ?>">
    ...
    <div class="mt-4 rounded-2xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm p-4 text-xs space-y-3">
        <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-xl bg-academic-800 text-white flex items-center justify-center text-sm font-bold shadow-md"><?php echo e($adminShellProfile['initials']); ?></div>
            <div>
                <h4 class="font-bold text-slate-900 dark:text-white text-xs"><?php echo e($adminShellProfile['name']); ?></h4>
                <p class="text-[10px] text-slate-500 dark:text-slate-400"><?php echo e($adminShellProfile['roleLabel']); ?></p>
            </div>
        </div>
        <div class="pt-2 border-t border-slate-100 dark:border-slate-700 space-y-1.5 text-[11px]">
            <div class="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
                ...
                <span class="truncate"><?php echo e($adminShellProfile['universityName']); ?></span>
            </div>
            <div class="flex items-center gap-1.5 font-mono text-[10px] text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-900 p-1.5 rounded-lg border border-slate-100 dark:border-slate-800">
                ...
                <span class="truncate"><?php echo e($adminShellProfile['email']); ?></span>
            </div>
        </div>
    </div>
</aside><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/admin/partials/sidebar.blade.php ENDPATH**/ ?>