<?php $__env->startSection('title', 'Supervisor Dashboard | Research Supervision Portal | LASU'); ?>
          ...
          <?php for($i=1; $i<=8; $i++): ?>
            <div class="bg-slate-50 dark:bg-slate-700/30 p-3 rounded-xl border border-slate-200 dark:border-slate-700/50">
              <div class="flex justify-between items-center mb-1">
                <span class="text-xs font-semibold text-slate-700 dark:text-slate-300">Stage <?php echo e($i); ?></span>
                <span class="text-xs font-bold text-academic-600 dark:text-academic-400"><?php echo e(rand(1, 3)); ?></span>
              </div>
              <div class="w-full bg-slate-200 dark:bg-slate-600 h-1.5 rounded-full overflow-hidden">
                <div class="bg-academic-600 dark:bg-academic-400 h-full rounded-full" style="width: <?php echo e(rand(20, 80)); ?>%"></div>
              </div>
            </div>
          <?php endfor; ?>
        </div>
            ...
            <tbody id="supervisor-student-tbody" class="divide-y divide-slate-100 dark:divide-slate-700">
              ...
              <?php for($i=1; $i<=5; $i++): ?>
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition">
                  <td class="px-3 py-3">
                    <div class="font-semibold text-slate-900 dark:text-white text-sm">Student <?php echo e($i); ?></div>
                    <div class="text-xs text-slate-500 dark:text-slate-400 font-mono">DEMO-00<?php echo e($i); ?></div>
                  </td>
                  <td class="px-3 py-3 hidden lg:table-cell">
                    <span class="text-xs text-slate-600 dark:text-slate-300 truncate block">Sample research topic for student <?php echo e($i); ?></span>
                  </td>
                  ...
                  <td class="px-3 py-3 hidden md:table-cell">
                    <div class="flex items-center gap-2">
                      <div class="w-full bg-slate-200 dark:bg-slate-600 h-1.5 rounded-full overflow-hidden flex-1">
                        <div class="bg-academic-600 dark:bg-academic-400 h-full rounded-full" style="width: <?php echo e($i * 15); ?>%"></div>
                      </div>
                      <span class="text-xs font-bold text-slate-700 dark:text-slate-300"><?php echo e($i * 15); ?>%</span>
                    </div>
                  </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/supervisor/dashboard.blade.php ENDPATH**/ ?>