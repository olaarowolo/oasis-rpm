  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400">
        ...
        <div>
          ...
          <p class="text-[11px]">Super Admin Command Center v<?php echo e(config('app.version', '1.0.0')); ?></p>
        </div>
      </div>

      <!-- Center: Quick Links -->
      <div class="hidden md:flex items-center gap-6 text-sm text-slate-500 dark:text-slate-400">
        <a href="<?php echo e(route('super-admin.dashboard')); ?>" class="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Dashboard</a>
        <a href="<?php echo e(route('super-admin.universities')); ?>" class="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Universities</a>
        <a href="<?php echo e(route('super-admin.users')); ?>" class="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Users</a>
        <a href="<?php echo e(route('super-admin.audit-logs')); ?>" class="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">Audit Logs</a>
        <a href="<?php echo e(route('super-admin.system-status')); ?>" class="hover:text-violet-600 dark:hover:text-violet-400 transition-colors">System Status</a>
      </div>
    ...
    <div class="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
      <div class="flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-slate-400 dark:text-slate-500">
        <p>&copy; <?php echo e(date('Y')); ?> OAsis Research Supervision Portal. All rights reserved.</p>
...
</style><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/components/super-admin/footer.blade.php ENDPATH**/ ?>