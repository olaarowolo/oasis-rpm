<?php $__env->startSection('title', 'Student Roster'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div class="bg-blue-50 rounded-lg p-6">
            <div class="text-3xl font-bold text-blue-600"><?php echo e($totalStudents); ?></div>
            <div class="text-gray-600">Total Students</div>
        </div>
        <div class="bg-green-50 rounded-lg p-6">
            <div class="text-3xl font-bold text-green-600"><?php echo e($activeStudents); ?></div>
            <div class="text-gray-600">Active Students</div>
        </div>
        <div class="bg-purple-50 rounded-lg p-6">
            <div class="text-3xl font-bold text-purple-600"><?php echo e($graduatedStudents); ?></div>
        ...
        <div class="mb-6 rounded-lg border border-slate-200 bg-slate-50 p-5">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <span class="text-sm text-slate-600">
                    <?php echo e($import['created'] ?? 0); ?> created, <?php echo e($import['skipped'] ?? 0); ?> skipped
                    (<?php echo e($import['duplicates'] ?? 0); ?> duplicate), <?php echo e(count($import['errors'] ?? [])); ?> error(s)
                </span>
            </div>
                ...
                <div class="mt-3 overflow-x-auto rounded-md border border-slate-200 bg-white">
                    <table class="min-w-full divide-y divide-gray-200 text-xs">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $import['errors']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-3 py-2 text-gray-800"><?php echo e($error['row'] ?? '—'); ?></td>
                                    <td class="px-3 py-2 text-gray-700 font-mono"><?php echo e($error['identifier'] ?? '—'); ?></td>
                                    <td class="px-3 py-2 text-gray-600"><?php echo e($error['reason']); ?></td>
                                </tr>
            ...
            <?php if(($import['created'] ?? 0) > 0): ?>
                <p class="mt-3 text-sm text-emerald-700">Successfully onboarded <?php echo e($import['created']); ?> student(s). Their temporary passwords are not shown here; students sign in using their university code, matric number and surname.</p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="mb-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form method="POST" action="<?php echo e(route('supervisor.students.import')); ?>" enctype="multipart/form-data" class="mt-4 grid grid-cols-1 sm:grid-cols-2 items-end gap-4">
            <?php echo csrf_field(); ?>
            <div>
            ...
            <div class="flex items-end gap-3">
                ...
                <a href="<?php echo e(route('supervisor.students.import.template')); ?>"
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($student->matric_number); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        Stage <?php echo e($student->current_stage); ?>

                        <span class="text-xs text-gray-400">(<?php echo e($student->progress_percentage); ?>%)</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="<?php echo e(url('/api/supervisor/students/' . $student->id)); ?>" class="text-blue-600 hover:text-blue-900">View</a>
                    </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
...
<?php echo $__env->make('layouts.supervisor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/olasunkanmiarowolo/Documents/OAsis-RS/Archive/oasis-rpm/resources/views/supervisor/students.blade.php ENDPATH**/ ?>